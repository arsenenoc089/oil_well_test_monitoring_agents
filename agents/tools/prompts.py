...
def make_prompt(threshold=0.1, file_path=file_path):
    ...
    "     • Do a final verification by checking the BHP values. The zone with Largest BHP tend to be the one that is closed.\n"
    ...
    f"    • Do a final verification by checking the BHP values. The zone with Largest BHP tend to be the one that is closed/optimized.\n"
